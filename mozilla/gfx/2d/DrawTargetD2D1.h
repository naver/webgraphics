...
public:
  ...
  bool Init(ID3D11Texture2D* aTexture, ID2D1DeviceContext* aDC, ID2D1Bitmap1* aBitmap, SurfaceFormat aFormat);
#endif
...
#if USE_WEBKIT_CHANGES
  static void SetFactory(ID2D1Factory1 *);
#endif
...
#if USE_WEBKIT_CHANGES
  virtual IntRect GetCurrentClipBounds() override;
#endif
